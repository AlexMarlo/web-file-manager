...
<?php
$this->renderPartial('_manager', array('tree' => $tree, 'p' => $p, 'len' => $len,
    'panel' => '1', 'p2' => $p2, ));
?>			
</td>
<td id="pan2" width="400" height="300">
<?php
$this->renderPartial('_manager', array('tree' => $tree2, 'p' => $p2, 'len' => $len2,
    'panel' => '2', 'p2' => $p, ));
?>			
</td>
    </tbody>
...
<table id="opMenu" width="200">
    <tbody>
        <td id="del" width="50"><button onclick="del('<?php echo Yii::app()->
homeUrl; ?>');">Delete selected</button></td>
        <td id="cop" width="50"><button onclick="cop('<?php echo Yii::app()->
homeUrl; ?>');">Copy selected</button></td>
        <td id="mov" width="50"><button onclick="mov('<?php echo Yii::app()->
homeUrl; ?>');">Move selected</button></td>
        <td id="dow" width="50"><button onclick="dow('<?php echo Yii::app()->
homeUrl; ?>');">Download selected</button></td>
    </tbody>
</table>
...
<table id="mkfdir">
    ...
    <td width="400" align="left"><b>make file or dir in FIRST panel folder:</b><br>
        ...
        <input type="button" value="file" class="but" onclick="mkfile(1,'<?php echo
Yii::app()->homeUrl; ?>')">
        <input type="button" value="dir" class="but" onclick="mkdir(1,'<?php echo
Yii::app()->homeUrl; ?>')">
    </td>
    ...
    <td width="400" align="left"><b>make file or dir in SECOND panel folder:</b><br>
        ...
        <input type="button" value="file" class="but" onclick="mkfile(2,'<?php echo
Yii::app()->homeUrl; ?>')">
        <input type="button" value="dir" class="but" onclick="mkdir(2,'<?php echo
Yii::app()->homeUrl; ?>')">
    </td>
    </tbody>
</table><br>
